    ...
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
      ...
      <Section title="Monetization">
        <Field
          ...
          hint="If you run an affiliate or referral program, paste your tracked link here. bindie.ai will route 'Visit Website' clicks through this URL and show you click counts on your dashboard. Leave blank to use your standard website URL."
        >
          <div className="flex">
            <span className="inline-flex items-center px-3 rounded-l-xl border border-r-0 border-grape/15 bg-grape/5 text-muted text-sm">
              https://
